<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="景点位置" prop="jingdianweizhi">
          <el-input v-model="ruleForm.jingdianweizhi" 
              placeholder="景点位置" clearable  :readonly="ro.jingdianweizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="景点位置" prop="jingdianweizhi">
              <el-input v-model="ruleForm.jingdianweizhi" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="景点评分" prop="jingdianpingfen">
          <el-input v-model="ruleForm.jingdianpingfen" 
              placeholder="景点评分" clearable  :readonly="ro.jingdianpingfen"></el-input>
        </el-form-item>
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="景点周边" prop="jingdianzhoubian">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.jingdianzhoubian" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jingdianzhoubian" label="景点周边" prop="jingdianzhoubian">
                    <span v-html="ruleForm.jingdianzhoubian"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jingdianxiangqing = true;
          ...
          if(o=='jingdianzhoubian'){
            this.ruleForm.jingdianzhoubian = obj[o];
	    this.ro.jingdianzhoubian = true;
            continue;
          }
          if(o=='clicktime'){
       ...
       this.ruleForm.jingdianpingfen='0'
      }
      // 获取用户信息
      this.$http({
	...
	this.ruleForm.jingdianxiangqing = this.ruleForm.jingdianxiangqing.replace(reg,'../../../springboot3zeu5/upload');
	this.ruleForm.jingdianzhoubian = this.ruleForm.jingdianzhoubian.replace(reg,'../../../springboot3zeu5/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
