<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.xianlutupian" label="线路图片" prop="xianlutupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.xianlutupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="交通方式" prop="jiaotongfangshi">
          <el-input v-model="ruleForm.jiaotongfangshi" 
              placeholder="交通方式" clearable  :readonly="ro.jiaotongfangshi"></el-input>
        </el-form-item>
        <div v-else>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.xianluxiangqing = this.ruleForm.xianluxiangqing.replace(reg,'../../../springboot3zeu5/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
