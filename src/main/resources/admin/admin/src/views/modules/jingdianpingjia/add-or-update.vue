    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="景点评分" prop="jingdianpingfen">
          <el-select :disabled="ro.jingdianpingfen" v-model="ruleForm.jingdianpingfen" placeholder="请选择景点评分">
            <el-option
...
export default {
  ...
  methods: {
	...
	this.ruleForm.jingdianpingjia = this.ruleForm.jingdianpingjia.replace(reg,'../../../springboot3zeu5/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
...
var objcross = this.$storage.getObj('crossObj');
      ...
      if(objcross!=null) {
	      objcross.jingdianpingfen = parseFloat(objcross.jingdianpingfen) + parseFloat(this.ruleForm.jingdianpingfen)
                }
