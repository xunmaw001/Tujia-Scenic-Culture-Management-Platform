<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="榜单名称" prop="bangdanmingcheng">
          <el-input v-model="ruleForm.bangdanmingcheng" 
              placeholder="榜单名称" clearable  :readonly="ro.bangdanmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="榜单名称" prop="bangdanmingcheng">
              <el-input v-model="ruleForm.bangdanmingcheng" 
                placeholder="榜单名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="数据来源" prop="shujulaiyuan">
          <el-input v-model="ruleForm.shujulaiyuan" 
              placeholder="数据来源" clearable  :readonly="ro.shujulaiyuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="数据来源" prop="shujulaiyuan">
              <el-input v-model="ruleForm.shujulaiyuan" 
                placeholder="数据来源" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="排行榜内容" prop="paixingbangneirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.paixingbangneirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.paixingbangneirong" label="排行榜内容" prop="paixingbangneirong">
                    <span v-html="ruleForm.paixingbangneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	bangdanmingcheng : false,
	tupian : false,
	biaoqian : false,
	shujulaiyuan : false,
	paixingbangneirong : false,
	gengxinriqi : false,
      },
      ruleForm: {
        bangdanmingcheng: '',
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='bangdanmingcheng'){
            this.ruleForm.bangdanmingcheng = obj[o];
	    this.ro.bangdanmingcheng = true;
            continue;
          }
          if(o=='tupian'){
	    ...
	    this.ro.biaoqian = true;
          ...
          if(o=='shujulaiyuan'){
            this.ruleForm.shujulaiyuan = obj[o];
	    this.ro.shujulaiyuan = true;
            continue;
          }
          if(o=='paixingbangneirong'){
            this.ruleForm.paixingbangneirong = obj[o];
	    this.ro.paixingbangneirong = true;
            continue;
          }
          if(o=='gengxinriqi'){
	...
	this.ruleForm.paixingbangneirong = this.ruleForm.paixingbangneirong.replace(reg,'../../../springboot3zeu5/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
